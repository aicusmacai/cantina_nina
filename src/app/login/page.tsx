...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 w-full max-w-md relative">
        <Link href="/" className="absolute top-6 left-6 text-slate-400 hover:text-nina-red-600 transition-colors text-sm font-medium flex items-center gap-1">
        ...
        <div className="mt-6 text-center text-sm text-slate-500">
          Não tem uma conta?{' '}
          <Link href="/cadastro" className="text-nina-red-600 hover:text-nina-red-700 font-medium">
            Cadastre-se
          </Link>
        </div>
      </div>
