      ...
      <AnimatePresence>
        {isOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              <div className="absolute top-0 right-0 w-48 h-48 bg-nina-gold-400/10 rounded-full blur-2xl -z-10 translate-x-1/3 -translate-y-1/3 pointer-events-none"></div>
              <button
                onClick={() => setIsOpen(false)}
              ...
              <form action={formAction} className="space-y-5 relative z-10">
                <div>
                  ...
                  <input
                    ...
                    type="text"
                    required
                    className="appearance-none relative block w-full px-4 py-3 bg-[#fdfcfa] border border-[#e8e6de] placeholder-nina-olive-300 text-[#2d2f27] font-medium rounded-xl focus:outline-none focus:ring-2 focus:ring-nina-gold-400/50 focus:border-nina-gold-400 focus:bg-white transition-all shadow-sm"
